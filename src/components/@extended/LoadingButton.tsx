...
interface StyleProps extends Omit<LoadingButtonStyleProps, 'theme'> {
  shape?: IconButtonShapeProps;
  loading: LoadingButtonProps['loading'];
}

const LoadingButtonStyle = styled(MuiLoadingButton, { shouldForwardProp: (prop) => prop !== 'shape' && prop !== 'variant' })<StyleProps>(
